...
**Фрейм** — это своеобразный это контейнер (рамка), который используется для группировки (объединения) других виджетов. Представьте себе прозрачную коробку: внутри неё можно хранить и размещать разные элементы (написи, кнопки, списки и т.д.).
